...
export default function ChatTab() {
  ...
  return (
    <div className="h-[100%] w-[40%] bg-white shadow-lg">
      <div className="h-[90%] shadow-lg flex p-3  gap-2 flex-col">
        {received.map((data, index) => (
          <div key={index} className="text-[1.3em] flex items-center px-2 ">
            <div className="max-w-[50%] break-words py-1 px-3 bg-[#f7f4f8] rounded-r-[1em] rounded-bl-[1em] min-h-[2em]  ">
              {data}
            </div>
          </div>
        ))}
      ...
      <div className="w-[100%] h-[10%] flex items-center">
        <div className="h-[80%] rounded-[2.5em] flex flex-row items-center  justify-center w-[100%]">
          ...
          <div className="flex w-[90%] h-[80%] border rounded-[2em] px-4">
            <input
              ...
              className="text-[1.2em] w-[75%] h-[100%] outline-none"
